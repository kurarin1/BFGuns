...
class WeaponListener implements Listener , Tags
{
    ...
    public function onJoin2(PlayerJoinEvent $event){
        ...
        //$event->getPlayer()->getInventory()->setContents([BFGuns::getWeaponManager()->getWeapon("AR01")->getItem(), BFGuns::getWeaponManager()->getWeapon("SMG01")->getItem(), BFGuns::getWeaponManager()->getWeapon("HG01")->getItem(), BFGuns::getWeaponManager()->getWeapon("SG01")->getItem()]);//デバッグコード
    }
